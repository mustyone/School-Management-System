        ...
        <div class="d-flex align-items-center">
            ...
            <!-- <form class="d-none d-md-inline-block" action="be_pages_generic_search.html" method="POST">
                <div class="input-group input-group-sm">
                    <input type="text" class="form-control form-control-alt" placeholder="Search student records" id="page-header-search-input2" name="page-header-search-input2">
                ...
                <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0 border-0" aria-labelledby="page-header-user-dropdown">
                    <div class="p-3 text-center bg-body-light border-bottom rounded-top">
                        ...
                        <p class="mt-2 mb-0 fw-medium">
                            <?= ucwords($_SESSION['user']['staff_name']); ?>
                        </p>
                        <p class="mb-0 text-muted fs-sm fw-medium">
                            <?= strtoupper($_SESSION['user']['staff_role']); ?>
                        </p>
                    </div>
                    <div class="p-2">

                        <a class="dropdown-item d-flex align-items-center justify-content-between" href="/result/admin/changepassword">
