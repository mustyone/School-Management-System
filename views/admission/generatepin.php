            ...
            <div class="content">
                ...
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Generate Pin</h3>
                    </div>
                    <div class="block-content block-content-full">
                            <form action="/admission/generatingpins" method="POST">
                                <div class="row push">
                                    <div class="col-lg-12">
                                        <div class="mb-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md">
                                                    <label class="form-label">
                                                       ...
                                                       <input required type="number" class="form-control" placeholder="Length of pin" name="length_of_pin">
                                                </div>
                                                <div class="col-md">
                                                    <label class="form-label">
                                                        Include Alphabate
                                                       ...
                                                       <input type="checkbox" name="include_alphabate">
                                                </div>
                                                <div class="col-md">
                                                    <label class="form-label">
                                                        Numbers Of Pins
                                                       ...
                                                       <input required type="number" class="form-control" placeholder="Numbers Of Pins" name="number_of_pins">
                                                </div>
                                                
                                            </div>  
                                            <div class="row">
                                                <div style="margin-top:30px;" class="col-md">
