              ...
              <div class="content">
                ...
                <div class="block block-rounded">
                    ...
                    <div class="block-content block-content-full">
                                <div class="row push">
                                    <div class="col-lg-12">
                                        <?php foreach($_SESSION['bulkadmissionletters'] as $admissionletters):?>
                                        <div class="mb-4">
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md">
                                                    <p style="margin:0;"><?= getSetting('school_address')." ".getSetting('school_telephone') ?></p>
                                                     <p><?= $admissionletters['fist_name']." ".$admissionletters['middle_name'] ." ".$admissionletters['last_name'];?></p>   
                                                </div>
                                            </div>
                                            <div class="row" style="padding-bottom:2%;">                                             
                                                <div class="col-md">
                                                    Dear <?= $admissionletters['first_name']." ".$admissionletters['middle_name'] ." ".$admissionletters['last_name'];?>,
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md">
                                                <div class="col-md">
                                                    <p>We are please to inform you that you have been admitted to the class of
                                                        <?=$admissionletters['session_name']?> for the <?= strtolower(getSetting('school_name'));?>.
                                        ...
                                        <?php endforeach;?>
                                        <?php unset($_SESSION['bulkadmissionletters']);?>     
                                    </div>
                                </div>
                    </div>
                </div>
