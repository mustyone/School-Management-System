            ...
            <div class="content">
                ...
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Create Exams</h3>
                    </div>
                    <div class="block-content block-content-full">
                        <form action="/cbt/insertcreateexams" method="POST">
                            <div class="row push">
                                <div class="col-lg-12">
                                    <div class="mb-4">
                                        <div class="row">
                                            <div class="col-md">
                                                ...
                                                <input required type="text" class="form-control" name="exam_name" placeholder="Exam Name">
                                            </div>
                                            <div class="col-md">
                                                <label class="form-label">
                                                ...
                                                <select class="form-control" name="class_id" id="">
                                                    ...
                                                    <?php foreach($records as $record):?>
                                                        <option value="<?= $record['class_id']?>"><?= $record['class_alternative_name']?></option>
                                                    <?php endforeach;?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        <div class="row">
                                            <div class="col-md">
                                                ...
                                                <input required type="number" class="form-control" placeholder="time" name="time_alloted_min">
                                            </div>
                                            <div class="col-md">
                                                <label class="form-label">
                                    ...
                                    <div class="mb-4">
                                        <div class="row">
                                            <div class="col-md">
                                                ...
                                                <textarea required class="form-control" name="instruction" id="instruction" cols="10" rows="2"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        <div class="row">
                                            ...
                                            <div class="col-md">
                                                ...
                                                <input required type="number" class="form-control" name="overallscore">
                                            </div>
                                            ...
                                            <tbody>
                                                <?php foreach ($sectionSubjects as $sectionName => $sectionSubject) : ?>
                                                    ...
                                                    <?php foreach ($sectionSubject as $subject) : ?>
                                                        <tr>
                                                            <td>
                                                                <input value="<?= $subject['subject_id'] ?>" type="checkbox" name="subject_ids[]" id="<?= $subject['subject_id'] ?>">
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input name="number_of_questions[]" class="form-control" type="number">
                                                            </td>
                                                            <td>
                                                                <input class="form-control" type="number" name="mark_per_questions[]" id="">
                                                            </td>
                                                        </tr>
