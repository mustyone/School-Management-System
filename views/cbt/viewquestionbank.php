                                            ...
                                            <?php foreach($questions as $i => $question) : ?>
                                                <div class="col-md-12 mb-3">
                                                    <div class="form-group mb-2">
                                                        ...
                                                        <textarea class="form-control texteditor" cols="2" rows="2" name="question-<?= $i ?>"></textarea>
                                                    </div>
                                                    ...
                                                    <div class="optionformats optionformat<?= $i; ?> optionformatMC-<?= $i; ?>">
                                                        ...
                                                        <div class="form-group MCOptionsWrapper<?= $i; ?>">
                                                            <div class="input-group mb-2">
                                                                <span class="input-group-text">
                                                                    <input style="cursor:pointer" type="checkbox" name="optionanswer-mc-<?= $i ?>[]" class="optionanswerradio">
                                                                </span>
                                                                <input type="text" name="options-mc-<?= $i ?>[]" class="form-control">
                                                                <span class="input-group-text">
                                                                    <button type="button" class='btn btn-sm text-danger deleteOption'>
                                                                        <i class='fa fa-trash'></i>
                                                                    </button>
