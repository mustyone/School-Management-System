            ...
            <div class="content">
                ...
                <div class="block block-rounded">
                    ...
                    <div class="block-content block-content-full">
                        <form action="/result/admin/newteacher" method="POST">
                            <div class="row push">
                                <div class="col-lg-12">
                                    ...
                                    <div class="mb-4">
                                        <div class="row">
                                            <div class="col-md">
                                                ...
                                                <input required type="text" placeholder="Example: T/001" class="form-control" name="user_name">
                                            </div>
                                            <div class="col-md">
                                                <label class="form-label">
                                                ...
                                                <input required type="text" placeholder="Example: 08133555446" class="form-control" name="phone_number">
