                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
                        ...
                        <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-alt">
                                ...
                                <li class="breadcrumb-item">
                                    <a class="link-fx" href="/result/admin/comments">Comments</a>
                                </li>
            ...
            <?php include APP_PATH. "/views/includes/message.php"; ?>
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Remove Comment</h3>
                    </div>
                    
                    <div class="block-content block-content-full">
                        <form action="/result/admin/deletecomment" method="POST">
                            ...
                            <div class="row push">
                                <div class="col-lg-12">
                                    <div class="alert alert-danger text-center">
                                        ...
                                        <p class="">All records tied to this record might be affected </p>
                                    </div>
