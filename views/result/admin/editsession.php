            ...
            <?php include APP_PATH. "/views/includes/message.php"; ?>
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Edit Academic Session</h3>
                    </div>
                    
                    <div class="block-content block-content-full">
                        <form action="/result/admin/updateacademicsession" method="POST">
                            <input type="hidden" value="<?= $id ?>" name="session_id" />
                            <div class="row push">
                                <div class="col-lg-12">
                                    <div class="mb-4">
                                        ...
                                        <input
                                            value="<?= $sessionRecord['session_name']; ?>"
                                            type="text" class="form-control" name="session_name" placeholder="2022/2023">
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        <div class="row">
                                            <div class="col-md">
                                                ...
                                                <input value="<?= $sessionRecord['start_date']; ?>" type="date" class="form-control" name="start_date">
                                            </div>
                                            ...
                                            <div class="col-md">
                                                ...
                                                <input value="<?= $sessionRecord['end_date']; ?>" type="date" class="form-control" name="end_date">
                                            </div>
                                        </div>
                                    </div>
