            ...
            <div class="content">
                ...
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Backups</h3>
                                ...
                                <?php foreach ($backups as $backup) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a href="<?= BASE_URL ?>/assets/uploads/backups/<?= $backup['filepath']; ?>" class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" data-bs-toggle="tooltip" title="Download">
                                                    <i class="fa fa-fw fa-download"></i>
                                                </a>
                                                <a href="/result/admin/deletebackup/<?= $backup['id']; ?>" class="btn btn-sm btn-alt-danger js-bs-tooltip-enabled" data-bs-toggle="tooltip" title="Delete Backup">
