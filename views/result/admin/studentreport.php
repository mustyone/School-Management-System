            ...
            <div class="content">
                ...
                <div class="block block-rounded no-print">
                    ...
                    <div class="block-content block-content-full">
                        <form action="/result/admin/fetchresult" method="POST">
                            <div class="row push">
                                ...
                                <div class="form-group col-3">
                                    <select class="form-control form-select" name="student_id" id="student_list">
                                ...
                                <div class="form-group col-2">
                                    <select required class="form-control" name="session_id">
                                        ...
                                        <?php foreach ($sessions as $session) : ?>
                                            <?php if ($session['session_status'] != "active") continue; ?>
                ...
                <?php if (isset($_SESSION['result'])) : ?>
                    <div class="block block-rounded">
                        <div class="block-header block-header-default no-print">
                            <h3 class="block-title">Student Reports</h3>
                            <button id="print" class="btn btn-default"><i class="fa fa-print"></i></button>
                        </div>
                        <div class="block-content block-content-full p-0">
                            <?php if ($_SESSION['type'] == "single") : ?>
                                <?php
                                include "single_result.php"
                                ?>
                            <?php endif; ?>

                            <?php if ($_SESSION['type'] == "multiple") : ?>

                                <?php
                                include "multiple_result.php"
                                ?>
                            <?php endif; ?>
                        </div>
                    </div>
