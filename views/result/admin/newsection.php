            ...
            <?php include APP_PATH. "/views/includes/message.php"; ?>
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">New School Section</h3>
                    </div>
                    <div class="block-content block-content-full">
                        <form action="/result/admin/newsection" method="POST">
                            <div class="row push">
                                <div class="col-lg-12">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="section_shot_code" placeholder="JS">
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="section_name" placeholder="Junior Secondary">
                                    </div>
