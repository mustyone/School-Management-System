                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
                        ...
                        <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-alt">
                                ...
                                <li class="breadcrumb-item">
                                    <a class="link-fx" href="/result/admin/allsections">Subjects</a>
                                </li>
            ...
            <div class="content">
                ...
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">New Subject</h3>
                    </div>
                    <div class="block-content block-content-full">
                        <form action="/result/admin/newsubject" method="POST">
                            <div class="row push">
                                <div class="col-lg-12">
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        <div class="row">
                                            <div class="col-md">
                                                ...
                                                <input required type="text" class="form-control" name="subject_name" placeholder="English Language">
                                            </div>
