            ...
            <div class="content">
                ...
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">School Sections</h3>
                    ...
                    <div class="block-content">
                        <table class="table table-hover table-vcenter">
                            ...
                            <tbody>
                                <?php $sn = 1; ?>
                                <?php foreach ($schoolSections as $section) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a href="/result/admin/editsection/<?= $section['section_id'] ?>" class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" data-bs-toggle="tooltip" aria-label="Edit section record">
                                                    <i class="fa fa-fw fa-pencil-alt"></i>
                                                </a>
                                                <a href="/result/admin/deletesection/<?= $section['section_id'] ?>" class="btn btn-sm btn-alt-danger js-bs-tooltip-enabled" data-bs-toggle="tooltip" aria-label="Remove record">
