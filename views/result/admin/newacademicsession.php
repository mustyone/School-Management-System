            ...
            <?php include APP_PATH. "/views/includes/message.php"; ?>
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">New Academic Session</h3>
                    </div>
                    <div class="block-content block-content-full">
                        <form action="/controllers/addnewsession.php" method="POST">
                            <div class="row push">
                                <div class="col-lg-12">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="session_name" placeholder="2022/2023">
                                    </div>
