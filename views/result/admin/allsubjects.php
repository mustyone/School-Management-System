                                ...
                                <?php foreach ($subjects as $subject) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a href="/result/admin/editsubject/<?= $subject['subject_id'] ?>" class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" data-bs-toggle="tooltip" title="Edit subject record">
                                                    <i class="fa fa-fw fa-pencil-alt"></i>
                                                </a>
                                                <a href="/result/admin/deletesubject/<?= $subject['subject_id'] ?>" class="btn btn-sm btn-alt-danger js-bs-tooltip-enabled" data-bs-toggle="tooltip" title="Remove record">
