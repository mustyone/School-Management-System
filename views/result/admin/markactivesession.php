            ...
            <?php include APP_PATH. "/views/includes/message.php"; ?>
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Remove Academic Session</h3>
                    </div>
                    
                    <div class="block-content block-content-full">
                        <form action="/result/admin/markactivesession" method="POST">
                                ...
                                <div class="col-lg-12">
                                    <div class="alert alert-info text-center">
                                        <h4>
                                            ...
                                            <span class="fw-bold"><?= $sessionRecord['session_name']; ?> </span>
                                            the active session
                                        </h4>
                                        <p class=""> This will make all other sessions become inactive </p>
                                    </div>

                                    <div class="mb-4">
                                        <select class="form-control" name="active_term" required>
                                            <option>Choose the active term</option>
