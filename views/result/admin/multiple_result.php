<?php foreach ($_SESSION['result'] as $student_id) : ?>
    <?php if (empty($student_id) || count($student_id) <= 0) continue; ?>
    <?php $student_result = $student_id[0]; ?>
    <table>
        <tr>
            ...
            <td style="width: 20%;">
                <img src="/student_pictures/<?php echo $student_result['result_student_id']; ?>.jpg" width="100px" height="100px" alt="">
            </td>
        ...
        <tr style="background-color:black;color:#fff;">
            <td colspan="3" class="text-center">
                <span class="h3" style="color:white;">
                    <?php echo strtoupper(getTermName($student_result['result_term'])) ?> TERM RESULT
                </span>
            </td>
        </tr>
    </table>
    <table>
        <tr>
            <td colspan="2">
                <table>
                    <tr>
                        ...
                        <td style="text-align: center ;">
                            <?php echo $student_result['class_alternative_name']; ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align: center ;">
                            <?php
                            echo strtoupper($student_result['student_first_name'] . " " . $student_result['student_middle_name'] . " " .  $student_result['student_last_name']);
                            ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align: center ;width:20%">
                            <?php
                            echo strtoupper($student_result['student_id']);
                            ?>
                        </td>
                    </tr>
                    <tr>
                        <td>GENDER</td>
                        <td style="text-align: center ;">
                            <?php echo strtoupper($student_result['gender'] ?? "NA") ?>
                        </td>
                    </tr>
            ...
            <td>
                <table>
                    ...
                    <tr>
                        <td>SESSION</td>
                        <td style="text-align: center ;"><?php echo $student_result['session_name']; ?></td>
                    </tr>
                    <tr>
                        <td>TERM</td>
                        <td style="text-align: center ;"><?php echo getTermName($student_result['result_term']); ?></td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align: center ;">
                            ...
                            echo $nic = number_in_class(
                                $student_result['result_session_id'],
                                $student_result['result_term'],
                                $student_result['result_class_id']
                            );
                            ?>
                        </td>
                    </tr>
        ...
        <tr>
            <?php
            $tests_category = fetchtests($student_result['result_class_id']);
            ?>
            <table>
                <thead>
                ...
                <tbody>
                    ...
                    <?php foreach ($student_id as $subjectResult) : ?>
                        <?php
    ...
    <table>
        <tr>
            ...
            <td style="margin-right:50px;vertical-align:top ;">
                <?php
                $gradingSystem = sectiongrading($student_result['section_id']);
                ?>
                <table>
                    <tr style="color:#fff;background-color:black;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            echo getAverageForSession(
                                $student_result['result_student_id'],
                                $student_result['result_session_id'],
                                $student_result['result_class_id']
                            );
                            ?>
                ...
                <table>
                    ...
                    <tr>
                        <td style="text-align:center ;" colspan="2">
                            <strong><?= strtoupper(getClassTeacherName($student_result['result_class_id'], $student_result['result_session_id'])); ?></strong>
                        </td>
                    </tr>
                    <tr style="background-color:black;color:white;">
                    ...
                    <tr>
                        <td style="text-align:center ;" colspan="2">
                            <?= $student_result['result_term'] !== 3 ? getTeacherComment($avgTerm) : ""; ?>
                        </td>
                    </tr>
    ...
    <table>
        <tr class="">
            ...
            <td colspan="2">
                <?= $student_result['result_term'] !== 3 ? getPrincipalComment($avgTerm) : ""; ?>
    ...
    <hr class="no-print" style="color:red;">
<?php endforeach; ?>