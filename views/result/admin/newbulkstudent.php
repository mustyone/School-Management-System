            ...
            <div class="content">
                ...
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Import Bulk Student Records</h3>
                        <a class="text-right" href="../../assets/template.xlsx" download="">
                            <i class="fa fa-download"></i>
                        </a>
                    </div>
                    <div class="block-content block-content-full">
                        <form action="/result/admin/newbulkstudent" enctype="multipart/form-data"  method="POST">
                            <div class="row push">
                                <div class="col-lg-12">
                                    <div class="mb-4">
                                        <div class="row">
                                            ...
                                            <div class="col-md">
                                                ...
                                                <input type="file" class="form-control" name="xlfile" required>
                                            </div>
                                        </div>
                                    </div>
