                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
                        ...
                        <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                ...
                                <li class="breadcrumb-item">
                                    <a class="link-fx" href="/result/admin/allsections">School Sections</a>
                                </li>
            ...
            <?php include APP_PATH. "/views/includes/message.php"; ?>
                ...
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Edit School Section</h3>
                    </div>
                    
                    <div class="block-content block-content-full">
                        <form action="/result/admin/editsection" method="POST">
                            ...
                            <div class="row push">
                                <div class="col-lg-12">
                                    <div class="mb-4">
                                        ...
                                        <input
                                            value="<?= $sectionRecord['section_shot_code']; ?>"
                                            type="text" class="form-control" name="section_shot_code" placeholder="JS">
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input
                                            value="<?= $sectionRecord['section_name']; ?>"
                                            type="text" class="form-control" name="section_name" placeholder="Junior Secondary">
                                    </div>
