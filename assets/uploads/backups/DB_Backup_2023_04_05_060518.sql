...
-- Date: Wed, 05 Apr 2023 18:05:18 +0000
...
SET autocommit=0;
INSERT INTO `backups` VALUES (4,'2022-12-08 11:43:27','DB_Backup_2022_12_08_114327.sql','Testing'),(5,'2022-12-22 14:43:03','DB_Backup_2022_12_22_024303.sql','Dec 22 Backup'),(7,'2023-04-03 18:28:22','DB_Backup_2023_04_03_052821.sql','Latest backup');
/*!40000 ALTER TABLE `backups` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `backups` with 3 row(s)
--
...
-- Dumped table `question_bank` with 0 row(s)
--
...
SET autocommit=0;
INSERT INTO `exams` VALUES (1,'First Term CA',1,3,1,'First term CA Exam','All protocols should be duly observed',10,'active','2023-02-08 15:45:04','2023-02-08 15:45:18',0);
/*!40000 ALTER TABLE `exams` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `exams` with 1 row(s)
--
...
CREATE TABLE `users` (
  ...
  `staff_role` enum('principal','eo','vp','super','admin','teacher','developer','admission_officer','exam_officer') NOT NULL,
...
SET autocommit=0;
INSERT INTO `users` VALUES ('0','super','Kayworld Technologies','super','$2y$10$qgVceMZZOnke9meYeoo0oeWYDlwNLBEzEDorQPuh0Sy0fv5MCGOGi','active'),('1','john','John Victor Asa','eo','$2y$10$qgVceMZZOnke9meYeoo0oeWYDlwNLBEzEDorQPuh0Sy0fv5MCGOGi','active'),('2','abu','Abu Abel','principal','$argon2i$v=19$m=65536,t=4,p=1$OXJ0ZTV2NUM5a2doeGs5bg$+RM42BJR7gAIzhMtrloItlEaHDZ93ygq1lIYJy+4CfQ','active'),('3','08135548934','Paul M Kansime','teacher','$2y$10$ivgQIq3Oh6MpKH6GtNYqouEBEEA3v7TsqdADqC7eZUhW33B24zkJy','active');
...
CREATE TABLE `exam_subjects` (
  ...
  `question_bank_id` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`question_bank_id`)),
...
SET autocommit=0;
INSERT INTO `exam_subjects` VALUES (1,1,1,0,'1','2023-02-08 15:46:20',0),(2,1,2,0,'2','2023-02-08 15:46:51',0),(3,1,3,0,'3','2023-02-08 15:47:17',0);
/*!40000 ALTER TABLE `exam_subjects` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `exam_subjects` with 3 row(s)
--
...
-- Dumped table `exam_result` with 0 row(s)
--
...
SET autocommit=0;
INSERT INTO `comments` VALUES (1,'A very poor result try harder next term',0,50,1,'teacher'),(2,'This is a poor result, put more effort next term and concentrate on your studies',0,50,1,'principal'),(3,'Average result, try harder next term',51,70,1,'teacher'),(4,'Average result, try harder next session',51,70,1,'principal'),(7,'An average result',71,80,1,'teacher'),(8,'You are a genius',81,100,1,'teacher');
/*!40000 ALTER TABLE `comments` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `comments` with 6 row(s)
--
...
-- Dumped table `exam_review` with 0 row(s)
--
...
SET autocommit=0;
INSERT INTO `teachers` VALUES (1,'Bulus Kagali','001','Mr','09132457643','$2y$10$rfTZhPAH2TvVoSnOhzk7/OQBCe3hm4ns6ZUC9pfitRK6ghv12LlfW','active',0),(2,'kasimu','002','Mr','0803432445','$2y$10$Bg81c1KN.LveuFDN22acIu3JtgOQTISPgTKe9J0p8VqV6tHmutIRu','active',2),(4,'Samuel James','003','Mr','08135548935','$argon2i$v=19$m=65536,t=4,p=1$OXJ0ZTV2NUM5a2doeGs5bg$+RM42BJR7gAIzhMtrloItlEaHDZ93ygq1lIYJy+4CfQ','active',1),(5,'Asmau','004','Mr','90909090909','$2y$10$rx/O6KW4k8EGF62slOeNFuHOjPmpcrKOd7knN4rIOwkd8wYGPEyni','active',4),(6,'loky','005','Mr','90234354320','$2y$10$KX5eIEs17P4LjJt1uV3fLe7n2FF037ENPsoc8SC.YRKvlxyAJIUbC','active',7),(7,'yusuf','006','Mr','67564586544','$2y$10$DRfIWfy/ZPmZuwBJUqaAk.XBDENu9w/uATAsaMSkjBwwygStwFwWK','active',0),(8,'muhammad muhammad muhammad','007','Mr','12345678912','$2y$10$TEvCm3G3y6osoerNR6HNlOkgMUqlTw2EM4CzKUHY7e6/tVlWrQU0S','active',0),(11,'Paul M Kansime','008','Mr','08135548934','$2y$10$ivgQIq3Oh6MpKH6GtNYqouEBEEA3v7TsqdADqC7eZUhW33B24zkJy','active',0);
...
SET autocommit=0;
INSERT INTO `settings` VALUES ('active_term','1'),('result_footer','Please acknowledge or make a comment about this result by sending a message to 09030897166 or send us an email at ecwassmc@gmail.com'),('school_address','12, Bello way, Sokoto South, Sokoto, Nigeria'),('school_closing_date','Jan 12, 2022'),('school_motto','In God We Trust'),('school_name','COLLEGE OF EDUCATION SOKOTO'),('school_resumption_date','Sept 12, 2022'),('school_telephone','08022211115');
...
SET autocommit=0;
INSERT INTO `teacher_subjects` VALUES (1,1,'1',1,3,1),(2,2,'2',1,3,1),(3,3,'1',1,3,1),(4,5,'4',1,3,1),(5,8,'1',1,3,1),(6,9,'8',1,3,1),(7,1,'2',2,3,1),(8,2,'5',2,3,1),(9,3,'7',2,3,1),(10,5,'8',2,3,1),(11,8,'11',2,3,1),(12,9,'1',2,3,1),(13,1,'5',5,3,1),(14,2,'7',5,3,1),(15,3,'8',5,3,1),(16,5,'4',5,3,1),(17,8,'11',5,3,1),(18,9,'1',5,3,1),(19,1,'11',8,3,1),(20,2,'1',8,3,1),(21,3,'5',8,3,1),(22,5,'11',8,3,1),(23,8,'11',8,3,1),(24,9,'11',8,3,1),(25,4,'8',3,3,1),(26,6,'6',3,3,1),(27,4,'4',4,3,1),(28,6,'1',4,3,1),(29,4,'8',6,3,1),(30,6,'11',6,3,1);
/*!40000 ALTER TABLE `teacher_subjects` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `teacher_subjects` with 30 row(s)
--
...
-- Dump completed on: Wed, 05 Apr 2023 18:05:19 +0000
